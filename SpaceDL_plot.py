...
bgo_err = np.array([0.03, 0.19, 0.55, 0.07, 1.77, 3.89])
bgores_y = np.array([13, 20, 40, 41, 55, 70])
bgores_yerr = np.array([0.09, 0.60, 6.88, 13.84, 25.92, 27.29])
bgoabseff_y = np.array([9.728e-03, 1.671e-02, 9.025e-03, 6.080e-03, 6.917e-03, 4.371e-03])
bgoabseff_yerr = np.array([2.447e-05, 2.176e-04, 1.223e-04, 4.073e-05, 3.526e-04, 2.550e-04])
...
nai_err = np.array([0.13, 0.10, 0.25, 0.74, 2.04])
naires_y = np.array([11.33, 12.67, 18.68, 33.63, 44.62])
naires_yerr = np.array([0.41, 0.69, 0.75, 2.17, 1.47])
naiabseff_y = np.array([2.982e-02, 4.246e-03, 1.112e-02, 3.894e-03, 1.444e-03])
naiabseff_yerr = np.array([8.452e-04, 2.001e-04, 2.272e-04, 4.671e-05, 1.052e-05])
...
cdte_err = np.array([0.18, 0.45, 0.12, 1.50])
cdteres_y = np.array([8.59, 10.09, 15.54, 33.66])
cdteres_yerr = np.array([0.43, 1.06, 0.28, 3.53])
cdteabseff_y = np.array([2.449e-04, 5.609e-05, 3.808e-05, 3.103e-05])
cdteabseff_yerr = np.array([8.821e-06, 3.328e-06, 8.452e-07, 2.817e-07])
